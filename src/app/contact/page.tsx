...
import { siteConfig, mapsEmbedUrl, mapsDirectUrl } from '@/lib/site-config';
...
const contactDetails = [
  {
    ...
    lines: [
      ...
      `${siteConfig.address.locality}, Accra, ${siteConfig.address.countryName}`,
    ],
    href: null,
  },
  {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-2 space-y-6">
              <SectionHeader
                label="Find Us"
                title="How to reach the Foundation"
                align="left"
                className="mb-8"
              />
      ...
      <section className="pb-16 md:pb-20" style={{ backgroundColor: '#FDFBF7' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative w-full overflow-hidden rounded-2xl shadow-sm" style={{ aspectRatio: '16 / 7', minHeight: '320px' }}>
            <iframe
              src={mapsEmbedUrl}
              width="100%"
              height="100%"
              ...
              title={`${siteConfig.name} headquarters — ${siteConfig.address.streetAddress}, ${siteConfig.address.locality}, Accra, ${siteConfig.address.countryName}`}
              className="absolute inset-0 h-full w-full border-0"
            />
          </div>
          <div className="mt-4 flex items-center justify-between gap-4 text-sm">
            <p className="text-[#000B58]/80">
              {siteConfig.address.streetAddress}, {siteConfig.address.locality}, Accra, {siteConfig.address.countryName}
            </p>
            <a
              href={mapsDirectUrl}
              target="_blank"
